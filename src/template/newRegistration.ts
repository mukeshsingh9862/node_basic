                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                                        <tr>
                                                                                            <td width="100%" align="center">
                                                                                                <img src="https://dev.test.io/logo.png" style="text-align: right; width: 200px;" />
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td class="full text-center">
                                                                        <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="color: #656565; font-family: 'Montserrat', sans-serif; font-size: 11px; text-align: center;">All rights reserved © ico.block-brew 2023</td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
