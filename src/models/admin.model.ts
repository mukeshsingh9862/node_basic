...
import { ADMIN_ROLE, USER_ROLE } from '../constants/user.constants';


const ClientSchema = new Schema(
    {
        role: { type: Number, enum: [ADMIN_ROLE], default: ADMIN_ROLE, index: true },
...
export default model('admin', ClientSchema)
